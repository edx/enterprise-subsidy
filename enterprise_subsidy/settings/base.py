...
BULK_ENROLL_CONNECT_TIMEOUT_SECONDS = int(os.environ.get('BULK_ENROLL_CONNECT_TIMEOUT_SECONDS', 2))
BULK_ENROLL_READ_TIMEOUT_SECONDS = int(os.environ.get('BULK_ENROLL_READ_TIMEOUT_SECONDS', 8))
BULK_ENROLL_RETRY_MAX_SECONDS = int(os.environ.get('BULK_ENROLL_RETRY_MAX_SECONDS', 30))
