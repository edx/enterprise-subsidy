...
pull_translations: ## pull translations from edx/openedx-translations via atlas (OEP-58)
	find enterprise_subsidy/conf/locale -mindepth 1 -maxdepth 1 -type d -exec rm -r {} \;
	atlas pull $(ATLAS_OPTIONS) translations/enterprise-subsidy/enterprise_subsidy/conf/locale:enterprise_subsidy/conf/locale
	python manage.py compilemessages
